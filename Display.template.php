...
function template_main()
{
	...
	while ($message = $context['get_message']())
	{
	    ...
	    echo '
		<span class="dp_info">', $context['jump_to']['board_name'], '&nbsp;|&nbsp;', $message['time'], '</span>
        <hr class="hrnew"/>
		<div class="dp_infopost">		
		    <span class="dp_title"><img src="', $message['icon_url'] . '" alt="" />', $context['subject'], '</span>		
		</div>
		<hr class="hrnew"/>';
		...
		if (!empty($message['member']['title']))
			echo '
								<li class="title">', $message['member']['title'], '<hr class="divider" /></li>';
		...
		if (!empty($message['member']['group']))
			echo '
								<li class="membergroup">', $message['member']['group'], '<hr class="divider" /></li>';
		...
		if (!$message['member']['is_guest'])
		{
			...
			echo '
								<li class="stars">', $message['member']['group_stars'], '<hr class="divider" /></li>';
			...
			if (!empty($settings['show_gender']) && $message['member']['gender']['image'] != '' && !isset($context['disabled_fields']['gender']))
				echo '
								<li class="gender">', $txt['gender'], ': ', $message['member']['gender']['image'], '<hr class="divider" /></li>';
								
			// Show their personal text?
			if (!empty($settings['show_blurb']) && $message['member']['blurb'] != '')
				echo '
								<li class="blurb">', $message['member']['blurb'], '<hr class="divider" /></li>';
				...
				foreach ($message['member']['custom_fields'] as $custom)
					if (empty($custom['placement']) || empty($custom['value']))
						echo '
								...
								<li class="custom"><hr class="divider" />', $custom['title'], ': ', $custom['value'], '</li>';
			}
			...
			if ($message['member']['can_see_warning'])
				echo '
								...
								<li class="warning"><hr class="divider" />', $context['can_issue_warning'] ? '<a href="' . $scripturl . '?action=profile;area=issuewarning;u=' . $message['member']['id'] . '">' : '', '<img src="', $settings['images_url'], '/warning_', $message['member']['warning_status'], '.gif" alt="', $txt['user_warn_' . $message['member']['warning_status']], '" />', $context['can_issue_warning'] ? '</a>' : '', '<span class="warn_', $message['member']['warning_status'], '">', $txt['warn_' . $message['member']['warning_status']], '</span></li>';
		}
