(function($) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      ...
      auto_join_text_reply: "Le respondí que",     // [string]   auto tense for replies: "i replied to" @someone "with"
      auto_join_text_url: "Yo estaba mirando",   // [string]   auto tense for urls: "i was looking at" http:...
